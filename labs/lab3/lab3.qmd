...
The keypad scanning and debouncing FSM waveforms can be viewed in Figures [8a](#fig-fsm-waveforms) and [8b](#fig-fsm-zoomed-in-waveforms) below.

::: {#fig-fsm-submodule-waveforms layout-ncol=2}
![Keypad scanner and debouncer module](images/keypad_scanner_and_debouncer_waveforms_2.png){#fig-fsm-waveforms .lightbox}

![Zoomed-in](images/keypad_scanner_and_debouncer_waveforms_zoomed_in_2.png){#fig-fsm-zoomed-in-waveforms .lightbox}
