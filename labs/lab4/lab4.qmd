...
![First note](images/first_note_trace.png){#fig-first-note-trace .lightbox}

![Second note](images/second_note_trace.png){#fig-second-note-trace .lightbox}
...
Finally, a few mathematical computations were performed in [Figure 6](#fig-1%-pitch-accuracy-calculations) to quantify just how much percent error the actual output comprised when compared to theoretical results, and ultimately show that none of these values for the 200 to 1000 Hz frequency range were greater than one percent, as desired:

![Accuracy verification calculations](images/1%25_pitch_accuracy_calculations.png){#fig-1%-pitch-accuracy-calculations}
